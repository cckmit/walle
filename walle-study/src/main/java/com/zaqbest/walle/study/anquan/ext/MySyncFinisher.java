package com.zaqbest.walle.study.anquan.ext;
...
public class MySyncFinisher {
     ...
     */
    public MySyncFinisher(int threadSize) {
        this.beginLatch = new CountDownLatch(1);
        this.threadSize = threadSize;
        this.executorService = ThreadUtil.newExecutor(threadSize, threadSize, 100000);
     ...
     * @return this
     */
    public MySyncFinisher setBeginAtSameTime(boolean isBeginAtSameTime) {
     ...
     * @return this
     */
    public MySyncFinisher addRepeatWorker(final Runnable runnable) {
     ...
     * @return this
     */
    public MySyncFinisher addWorker(final Runnable runnable) {
     ...
     * @return this
     */
    synchronized public MySyncFinisher addWorker(Worker worker) {
        workers.add(worker);
        return this;
    }
